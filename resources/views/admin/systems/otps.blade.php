        ...
        <form class="needs-validation" novalidate enctype="multipart/form-data" method="POST" id="form-form"
            ...
            <div class="row mb-6">
                ...
                <div class="col-12">
                    <div class="card mb-6">
                        <div class="card-header">
                            <h4 class="card-title">Cấu hình giới hạn OTP</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="col-12 mb-6">
                                        <label class="form-label" for="type_otp">Dịch vụ gửi OTP</label>
                                        <input type="text" class="form-control" id="type_otp" name="type_otp"
                                            value="{{ showValueSystem($data, 'type_otp') }}"
                                            placeholder="Loại hình gửi OTP" aria-label="Loại hình gửi OTP" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="col-12 mb-6">
                                        <label class="form-label" for="limit_otp">Giới hạn gửi OTP</label>
                                        <input type="text" class="form-control" id="limit_otp" name="limit_otp"
                                            value="{{ showValueSystem($data, 'limit_otp') }}"
                                            placeholder="Giới hạn gửi OTP" aria-label="Giới hạn gửi OTP" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="col-12 mb-6">
                                        <label class="form-label" for="limit_forget">Giới hạn quên mật khẩu</label>
                                        <input type="text" class="form-control" id="limit_forget" name="limit_forget"
                                            value="{{ showValueSystem($data, 'limit_forget') }}"
                                            placeholder="Giới hạn quên mật khẩu" aria-label="Giới hạn quên mật khẩu" />
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-12">
                    <div class="card mb-6">
                        <div class="card-header">
                            <h4 class="card-title">Cấu hình eSMS</h4>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="col-12 mb-6">
                                        <label class="form-label" for="esms_secret_key">eSMS secret key</label>
                                        <input type="text" class="form-control" id="esms_secret_key"
                                            name="esms_secret_key" value="{{ showValueSystem($data, 'esms_secret_key') }}"
                                            placeholder="eSMS secret key" aria-label="eSMS secret key" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="col-12 mb-6">
                                        <label class="form-label" for="esms_api_key">eSMS Api key</label>
                                        <input type="text" class="form-control" id="esms_api_key" name="esms_api_key"
                                            value="{{ showValueSystem($data, 'esms_api_key') }}"
                                            placeholder="eSMS Api key" aria-label="eSMS Api key" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="col-12 mb-6">
                                        <label class="form-label" for="esms_brandname">eSMS Bandname</label>
                                        <input type="text" class="form-control" id="esms_brandname"
                                            name="esms_brandname" value="{{ showValueSystem($data, 'esms_brandname') }}"
                                            placeholder="eSMS Bandname" aria-label="eSMS Bandname" />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="col-12 mb-6">
                                        <label class="form-label" for="esms_url">eSMS URL</label>
                                        <input type="text" class="form-control" id="esms_url" name="esms_url"
                                            value="{{ showValueSystem($data, 'esms_url') }}" placeholder="eSMS URL"
                                            aria-label="eSMS URL" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="col-12 mb-6">
                                        <label class="form-label" for="esms_content">eSMS Content</label>
                                        <input type="text" class="form-control" id="esms_content" name="esms_content"
                                            value="{{ showValueSystem($data, 'esms_content') }}"
                                            placeholder="eSMS Content" aria-label="eSMS Content" />
                                    </div>
                                </div>
                            </div>
