            ...
            <div class="row mb-6">
                ...
                <div class="col-12">
                    <div class="card mb-6">
                        <div class="card-body">
                            <div class="row">
                                <label for="">Google Auth</label>
                                <div class="col-6 mb-6">
                                    <label class="form-label" for="google_type">
                                        Type
                                    </label>
                                    <input type="text" class="form-control" id="google_type" name="google_type"
                                        value="{{ showValueSystem($data, 'google_type') }}" placeholder="Google auth type"
                                        aria-label="Google auth type" />
                                </div>
                                <div class="col-6 mb-6">
                                    <label class="form-label" for="google_project_id">
                                        Project id
                                    </label>
                                    <input type="text" class="form-control" id="google_project_id"
                                        name="google_project_id" value="{{ showValueSystem($data, 'google_project_id') }}"
                                        placeholder="Google auth project id" aria-label="Google auth project id" />
                                </div>
                                <div class="col-6 mb-6">
                                    <label class="form-label" for="google_client_email">
                                        Client email
                                    </label>
                                    <input type="text" class="form-control" id="google_client_email"
                                        name="google_client_email"
                                        value="{{ showValueSystem($data, 'google_client_email') }}"
                                        placeholder="Google client email" aria-label="Google client email" />
                                </div>
                                <div class="col-6 mb-6">
                                    ...
                                    <input type="text" class="form-control" id="google_client_id" name="google_client_id"
                                        value="{{ showValueSystem($data, 'google_client_id') }}"
                                        placeholder="Google client id" aria-label="Google client id" />
                                </div>
                                <div class="col-6 mb-6">
                                    <label class="form-label" for="google_private_key_id">
                                        Private Key Id
                                    </label>
                                    <input type="text" class="form-control" id="google_private_key_id"
                                        name="google_private_key_id"
                                        value="{{ showValueSystem($data, 'google_private_key_id') }}"
                                        placeholder="Google private key id" aria-label="Google private key id" />
                                </div>
                                <div class="col-6 mb-6">
                                    <label class="form-label" for="google_private_key">
                                        Private Key
                                    </label>
                                    <textarea class="form-control" name="google_private_key" id="google_private_key" cols="30" rows="30">{{ showValueSystem($data, 'google_private_key') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card mb-6">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-6 mb-6">
                                    <label class="form-label" for="google_recaptcha_site_key">
                                        Google recaptcha site key
                                    </label>
                                    <input type="text" class="form-control" id="google_recaptcha_site_key"
                                        name="google_recaptcha_site_key"
                                        value="{{ showValueSystem($data, 'google_recaptcha_site_key') }}"
                                        placeholder="Google recaptcha site key" aria-label="Google recaptcha site key" />
                                </div>
                                <div class="col-6 mb-6">
                                    <label class="form-label" for="google_recaptcha_secret_key">
                                        Google recaptcha secret key
                                    </label>
                                    <input type="text" class="form-control" id="google_recaptcha_secret_key"
                                        name="google_recaptcha_secret_key"
                                        value="{{ showValueSystem($data, 'google_recaptcha_secret_key') }}"
                                        placeholder="Google recaptcha secret key"
                                        aria-label="Google recaptcha secret key" />
                                </div>
                            </div>
                        </div>
                    </div>
