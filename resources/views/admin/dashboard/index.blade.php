                    ...
                    <div class="swiper-wrapper">
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                                        <img src="{{ asset('assets/admin/img/illustrations/card-website-analytics-1.png') }}"
                        ...
                        <div class="swiper-slide">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                                    <img src="{{ asset('assets/admin/img/illustrations/card-website-analytics-2.png') }}"
                                        alt="Website Analytics" height="150" class="card-website-analytics-img" />
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="row">
                                ...
                                <div class="col-lg-5 col-md-3 col-12 order-1 order-md-2 my-4 my-md-0 text-center">
                                    <img src="{{ asset('assets/admin/img/illustrations/card-website-analytics-3.png') }}"
                                        alt="Website Analytics" height="150" class="card-website-analytics-img" />
                                </div>
                            </div>
                        </div>
...
@push('js')
    ...
    <!-- Page JS -->
    <script src="{{ asset('assets/admin/js/app-ecommerce-product-list.js') }}"></script>
@endpush
