            ...
            <div class="card-header border-bottom">
                ...
                <div class="d-flex justify-content-between align-items-center row pt-4 gap-4 gap-md-0">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-4">
                            <input class="form-control" type="date" value="{{ date('Y-m-d') }}" id="filter_date"
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="canvas-form" aria-labelledby="offcanvasAddUserLabel">
                ...
                <div class="offcanvas-body mx-0 flex-grow-0 p-6 h-100">
                    ...
                    <form class="pt-0" id="form-form" method="POST" action="{{ route('admin.departments.store') }}"
                        ...
                        @csrf
                        <div class="mb-6">
                            <label class="form-label" for="add-user-fullname">Tên chi nhánh
                        ...
                        <div class="mb-6">
                            <label class="form-label" for="add-user-email">Tỉnh/Thành
                                <span class="text-danger">*</span>
                            </label>
